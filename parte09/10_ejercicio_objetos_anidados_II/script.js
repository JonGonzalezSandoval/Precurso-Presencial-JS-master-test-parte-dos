...
let primeraNombre = nombre.toLocaleLowerCase().charAt(0);
let apellido = prompt("Introduce tu apellido");
let ultimaApeliido = apellido.toLocaleLowerCase().charAt(apellido.length-1);
let nacimiento = prompt("introduce tu fecha de nacimiento formato XX/XX/XXXX");
let numeroNacimiento = nacimiento.charAt(nacimiento.length - 1);

let nombreCompleto = letraNombre[primeraNombre].masculino + " " + letraApellido[ultimaApeliido].masculino + " " + fechaNacimiento[numeroNacimiento].masculino;
