let randomObject ={
    ...
    let claveBoard = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board;
    console.log(claveBoard);

    let valorUsuario = prompt("Introduce el nombre a guardar:");
