...
if (personas.hasOwnProperty(busqueda)) {
    let persona = personas[busqueda];
    ...
    document.querySelector("#age").innerHTML = persona.age;
    document.querySelector("#email").innerHTML = persona.email;
    document.querySelector("#address").innerHTML = persona.address;
}else{
    alert("No existe nadie con ese nombre en nuestra base de datos!");
}
